...
_FIELD_ALLOWED_DOCS: dict[str, tuple[str, ...]] = {
    # --- A.1 Personal (passport only — không lấy từ ds260 khách khai theo yêu cầu) ---
    "applicant_name": (_PASS,),
    "applicant_name_native": (_PASS,),
    "other_name_used": (_WS,),
    "other_names": (_WS,),
    "family_name": (_PASS,),
    "given_names": (_PASS,),
    "date_of_birth": (_PASS,),
    "place_of_birth": (_PASS,),
    "birth_city": (_PASS,),
    "birth_state": (_PASS,),
    "birth_country": (_PASS,),
    "gender": (_PASS,),
    "nationality": (_PASS,),
    "id_card_number": (_PASS,),
    "current_marital_status": (_WS, _DIV, _MARR, _PASS),
    # --- A.2 Passport (strict — không cross-fill từ giấy tờ khác) ---
    "passport_number": (_PASS,),
    "passport_issue_date": (_PASS,),
    "passport_expiration_date": (_PASS,),
    "passport_place_of_issue": (_PASS,),
    "passport_issuing_country": (_PASS,),
    ...
    "father_birth_city": (_WS,),
    "father_birth_state": (_WS,),
    "father_birth_country": (_WS,),
    ...
    "mother_birth_city": (_WS,),
    "mother_birth_state": (_WS,),
    "mother_birth_country": (_WS,),
    ...
    **{
    ...
    "other_languages": (_WS,),
    "traveled_countries_5yr_used": (_WS,),
    "traveled_countries_history": (_WS,),
    # --- F. Security & Background (toàn bộ Yes/No — khách khai) ---
    "communicable_disease": (_WS,),
    "has_vaccination_docs": (_WS,),
    "mental_physical_disorder": (_WS,),
    "drug_abuser": (_WS,),
    "arrested_convicted": (_WS,),
    "violated_controlled_substance": (_WS,),
    "family_drug_trafficking_benefited": (_WS,),
    "prostitution": (_WS,),
    "money_laundering": (_WS,),
    "human_trafficking_committed": (_WS,),
    "human_trafficking_aided": (_WS,),
    "family_human_trafficking_benefited": (_WS,),
    "espionage_sabotage": (_WS,),
    "terrorist_activities": (_WS,),
    "terrorist_financial_support": (_WS,),
    "terrorist_org_member": (_WS,),
    "family_terrorist_activity": (_WS,),
    "genocide": (_WS,),
    "torture": (_WS,),
    "extrajudicial_killings": (_WS,),
    "child_soldiers": (_WS,),
    "religious_freedom_violations": (_WS,),
    "communist_party_member": (_WS,),
    "colombia_groups_support": (_WS,),
    "abuse_position_confiscate_property": (_WS,),
    "family_abuse_position_property": (_WS,),
    "population_control_abortion": (_WS,),
    "chemical_weapons_disclosure": (_WS,),
    "family_chemical_weapons_disclosure": (_WS,),
    "visa_fraud": (_WS,),
    "removed_deported": (_WS,),
    "withheld_custody_us_child": (_WS,),
    "assisted_withhold_custody": (_WS,),
    "voted_illegally": (_WS,),
    "renounced_citizenship_tax": (_WS,),
    "attended_public_school_f_status": (_WS,),
    "skilled_labor_no_certification": (_WS,),
    "foreign_medical_grad_no_exam": (_WS,),
    "health_care_worker_no_cert": (_WS,),
    "permanently_ineligible_citizenship": (_WS,),
    "departed_us_evade_military": (_WS,),
    "polygamy": (_WS,),
    "exchange_visitor_j_unfulfilled": (_WS,),
    "frivolous_asylum": (_WS,),
    "public_charge": (_WS,),
    # --- G. Social Security Number ---
    "applied_ssn_before": (_WS,),
    "want_ssn_issued": (_WS,),
    "authorize_ssn_disclosure": (_WS,),
}
